...
static#p=(()=>dt7948.g(this.prototype,"replyChannel",[t.tracked]))()
#l=(()=>{dt7948.i(this,"replyChannel")})()
...
e.default=i})),define("discourse/plugins/discourse-presence/discourse/connectors/topic-above-footer-buttons/presence",["exports","discourse/plugins/discourse-presence/discourse/components/topic-presence-display","@ember/component","@ember/template-factory","@ember/component/template-only"],(function(e,s,t,r,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const i=(0,t.setComponentTemplate)((0,r.createTemplateFactory)({id:"cMRyU8Bw",block:'[[[1,"\\n  "],[10,0],[14,0,"topic-above-footer-buttons-outlet presence"],[12],[1,"\\n    "],[8,[32,0],null,[["@topic"],[[30,1,["model"]]]],null],[1,"\\n  "],[13],[1,"\\n"]],["@outletArgs"],false,[]]',moduleName:"/var/www/discourse/app/assets/javascripts/discourse/discourse/plugins/discourse-presence/discourse/connectors/topic-above-footer-buttons/presence.js",scope:()=>[s.default],isStrictMode:!0}),(0,n.default)(void 0,"presence:Presence"))
e.default=i})),define("discourse/plugins/discourse-presence/discourse/services/composer-presence-manager",["exports","@ember/runloop","@ember/service","discourse/lib/environment"],(function(e,s,t,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
//# sourceMappingURL=discourse-presence-c42d216c.map